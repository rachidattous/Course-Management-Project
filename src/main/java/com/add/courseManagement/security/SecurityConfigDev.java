package com.add.courseManagement.security;
...
public class SecurityConfigDev extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeRequests(authorizeRequests -> authorizeRequests
                        ...
                        .antMatchers("/api/course/doc").permitAll()
